...
void benchmarkCOD(rawDomain  *rawDomains, rawDomain  *queries, int n, int q, double threshold, int subset){
    std::string linearscanOutput = "_cod_linearscan_threshold=" + std::to_string(threshold) + ",subset=" + std::to_string(n);
	std::string lshensembleOutput = "M_cod_lshensemble_threshold=" + std::to_string(threshold) + ",subset=" + std::to_string(n);
	std::string accuracyOutput = "M_cod_accuracy_threshold=" + std::to_string(threshold) + ",subset=" + std::to_string(n);
...
int main(int argc, char* argv[]) {
    ...
    numDomains = readDomains(rawDomains, "../test_dir");
